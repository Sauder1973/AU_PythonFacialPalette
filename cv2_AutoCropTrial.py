...
CV2_FILETYPES = [ ".bmp",   ".dib",".jp2",".jpe",".jpeg",".jpg",".pbm",".pgm",".png",".ppm",".ras",".sr",".tif",".tiff", ".webp",]
# File types supported by Pillow
PILLOW_FILETYPES = [ ".eps",    ".gif",    ".icns",    ".ico",    ".im",    ".msp",    ".pcx",    ".sgi",    ".spi",    ".xbm",]
CASCFILE = "C:/Users/WesSa/Python37_VENV/pyfeat37\Lib/site-packages/cv2/data/haarcascade_frontalface_alt2.xml"
...
imageToCrop = "f:/Tom_Hanks_face - Copy"    
